# discord-external-assets Spec

## Purpose
Support external image URLs in Discord Rich Presence assets by resolving HTTP and HTTPS asset URLs and formatting them using Discord's external asset proxy format for RPC transmission.
